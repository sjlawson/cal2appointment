 ...
 * @subpackage Components
 */
class ClientpipeControllerexception extends ClientpipeController
{
	/**
	...
	function save()
	{
		...
		$link = 'index.php?option=com_clientpipe&view=exception';
	...
	function remove()
	{
		...
		$this->setRedirect( 'index.php?option=com_clientpipe&view=exception', $msg );
	}
