...
<a href="<?php echo $applink ?>" >Schedule Exceptions</a>
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)	{
		...
		$link 		= JRoute::_( 'index.php?option=com_clientpipe&controller=appointment&task=edit&cid[]='. $row->appointment_id );
		?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<?php 
				$objStaff = ClientpipeModelAppointment::getStaff($row->staff_id);
