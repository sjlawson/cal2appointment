...
/*******************************************************************************
 * Show Hint script- Dynamic Drive (www.dynamicdrive.com) This notice MUST stay
 * intact for legal use Visit http://www.dynamicdrive.com/ for this script and
 * 100s more. (but you will have to clean them up a bit because the code is
 * SLOPPY!)
 ******************************************************************************/

var horizontal_offset = "100px"; // horizontal offset of hint box from anchor
									// link
...
function showhint(menucontents, obj, e, tipwidth, side) {
	if ((ie || ns6) && document.getElementById("hintbox")) {
		...
		if (side == "left") {
			dropmenuobj.style.left = (dropmenuobj.x - 400
					- clearbrowseredge(obj, "leftedge") - obj.offsetWidth + "px");
			dropmenuobj.style.top = dropmenuobj.y
					- clearbrowseredge(obj, "bottomedge") + "px";
		} else {
			dropmenuobj.style.left = dropmenuobj.x
					- clearbrowseredge(obj, "rightedge") + obj.offsetWidth
					+ "px";
			dropmenuobj.style.top = dropmenuobj.y
					- clearbrowseredge(obj, "bottomedge") + "px";
		}
